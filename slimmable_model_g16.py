...
class AttnBlock(nn.Module):
    def __init__(self, in_ch):
        super().__init__()
        self.group_norm = SlimmableGroupNorm2d(16, in_ch)
...
class ResBlock(nn.Module):
    def __init__(self, in_ch, out_ch, tdim, dropout, attn=False):
        ...
        self.block2 = nn.Sequential(
            SlimmableGroupNorm2d(16, out_ch),
            Swish(),
            nn.Dropout(dropout),
...
class Slimmable16UNet(nn.Module):
...
class StepAware16UNet(Slimmable16UNet):
